                ...
                >
                  ...
                  >
                    <p className="max-w-md font-normal text-gray-600 text-base">
                      Embark on a strategic journey in a 1v1 Rook Move Game on
                      an 8x8 chessboard. <strong>Outsmart your opponent</strong>{" "}
                      with quick thinking, navigating your rook to the
                      bottom-left corner for victory.
                    </p>
                    <CustomButton
                      type="filled"
                      title="Play Game"
                  ...
                  >
                    ...
                    <div className="max-w-md text-gray-600 text-lg">
                      <ul className="list-disc pl-4">
                        ...
                        <li className="mb-2">
                          There will be two players, and they will take turns to
                          move the rook. Rooks start from the top right square.
                        </li>
                        <li className="mb-2">
                          On each turn, a player can move the rook any number of
                          steps to the left or down, but not up, right, or
                          diagonally.
                        </li>
                        <li>
                          The player who reaches the bottom-left corner of the
